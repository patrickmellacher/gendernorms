...
<experiments>
  <experiment name="experiment_1" repetitions="1" runMetricsEveryStep="false">
    ...
    <metric>median [current-utility] of men</metric>
    <steppedValueSet variable="random-seed-fixed" first="1" step="1" last="100"/>
  ...
  <experiment name="with conformism CES beta" repetitions="1" runMetricsEveryStep="false">
    <setup>setup
set current-delta 0.0001</setup>
    <go>go</go>
    <timeLimit steps="100"/>
    <metric>mean [current-utility] of men</metric>
    <metric>mean [current-utility] of women</metric>
    ...
    <steppedValueSet variable="CES_beta" first="-1" step="0.01" last="1"/>
    <enumeratedValueSet variable="norm-paid-time-male">
      <value value="80"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="watts-strogatz-neighbors">
    ...
    <steppedValueSet variable="conformism-male" first="0" step="1" last="5"/>
    ...
    <steppedValueSet variable="conformism-female" first="0" step="1" last="5"/>
    <enumeratedValueSet variable="output-locations">
      <value value="false"/>
    </enumeratedValueSet>
  </experiment>
